...
_system_folder1 = "/data/data/com.termux/files/usr/etc/systemd/system"
_system_folder2 = "/data/data/com.termux/files/usr/var/run/systemd/system"
_system_folder3 = "/data/data/com.termux/files/usr/var/run/systemd/system"
_system_folder4 = "/data/data/com.termux/files/usr/local/lib/systemd/system"
_system_folder5 = "/data/data/com.termux/files/usr/lib/systemd/system"
_system_folder6 = "/system/lib/systemd/system"
_system_folderX = None
_user_folder1 = "{XDG_CONFIG_HOME}/systemd/user"
_user_folder2 = "/data/data/com.termux/files/usr/etc/systemd/user"
_user_folder3 = "{XDG_RUNTIME_DIR}/systemd/user"
_user_folder4 = "/data/data/com.termux/files/usr/var/run/systemd/user"
_user_folder5 = "/data/data/com.termux/files/usr/var/run/systemd/user"
_user_folder6 = "{XDG_DATA_HOME}/systemd/user"
_user_folder7 = "/data/data/com.termux/files/usr/local/lib/systemd/user"
_user_folder8 = "/data/data/com.termux/files/usr/lib/systemd/user"
_user_folder9 = "/system/lib/systemd/user"
_user_folderX = None
_init_folder1 = "/data/data/com.termux/files/usr/etc/init.d"
_init_folder2 = "/data/data/com.termux/files/usr/var/run/init.d"
_init_folder3 = "/data/data/com.termux/files/usr/var/run/init.d"
_init_folderX = None
_preset_folder1 = "/data/data/com.termux/files/usr/etc/systemd/system-preset"
_preset_folder2 = "/data/data/com.termux/files/usr/var/run/systemd/system-preset"
_preset_folder3 = "/data/data/com.termux/files/usr/var/run/systemd/system-preset"
_preset_folder4 = "/data/data/com.termux/files/usr/local/lib/systemd/system-preset"
_preset_folder5 = "/data/data/com.termux/files/usr/lib/systemd/system-preset"
_preset_folder6 = "/system/lib/systemd/system-preset"
_preset_folderX = None

# standard paths
_dev_null = "/dev/null"
_dev_zero = "/dev/zero"
_etc_hosts = "/data/data/com.termux/files/usr/etc/hosts"
_rc3_boot_folder = "/data/data/com.termux/files/usr/etc/rc3.d"
_rc3_init_folder = "/data/data/com.termux/files/usr/etc/init.d/rc3.d"
_rc5_boot_folder = "/data/data/com.termux/files/usr/etc/rc5.d"
_rc5_init_folder = "/data/data/com.termux/files/usr/etc/init.d/rc5.d"
...
DefaultPath = "/data/data/com.termux/files/usr/local/sbin:/data/data/com.termux/files/usr/local/bin:/data/data/com.termux/files/usr/sbin:/data/data/com.termux/files/usr/bin:/sbin:/bin"
ResetLocale = ["LANG", "LANGUAGE", "LC_CTYPE", "LC_NUMERIC", "LC_TIME", "LC_COLLATE", "LC_MONETARY",
               "LC_MESSAGES", "LC_PAPER", "LC_NAME", "LC_ADDRESS", "LC_TELEPHONE", "LC_MEASUREMENT",
               "LC_IDENTIFICATION", "LC_ALL"]
LocaleConf="/data/data/com.termux/files/usr/etc/locale.conf"
...
TAIL_CMD = "/data/data/com.termux/files/usr/bin/tail"
LESS_CMD = "/data/data/com.termux/files/usr/bin/less"
CAT_CMD = "/data/data/com.termux/files/usr/bin/cat"

# The systemd default was NOTIFY_SOCKET="/data/data/com.termux/files/usr/var/run/systemd/notify"
...
def get_runtime_dir():
    ...
    user = os_getlogin()
    return "/data/data/com.termux/files/usr/tmp/run-"+user
def get_RUN(root = False):
    tmp_var = get_TMP(root)
    if _root:
        tmp_var = _root
    if root:
        for p in ("/data/data/com.termux/files/usr/var/run", "/data/data/com.termux/files/usr/var/run", "{tmp_var}/run"):
            path = p.format(**locals())
            if os.path.isdir(path) and os.access(path, os.W_OK):
                return path
        os.makedirs(path) # "/data/data/com.termux/files/usr/tmp/run"
        return path
    else:
        uid = get_USER_ID(root)
        for p in ("/data/data/com.termux/files/usr/var/run/user/{uid}", "/data/data/com.termux/files/usr/var/run/user/{uid}", "{tmp_var}/run-{uid}"):
            path = p.format(**locals())
            if os.path.isdir(path) and os.access(path, os.W_OK):
                return path
        os.makedirs(path, 0o700) # "/data/data/com.termux/files/usr/tmp/run/user/{uid}"
        return path
...
def get_VARTMP(root = False):
    VARTMP = "/data/data/com.termux/files/usr/var/tmp"
...
def get_VARLIB_HOME(root = False):
    VARLIB = "/data/data/com.termux/files/usr/var/lib"
...
class Systemctl:
    ...
    def expand_special(self, cmd, conf):
        ...
        def get_confs(conf):
            ...
            #
            root = conf.root_mode()
            VARTMP = get_VARTMP(root)     # $TMPDIR              # "/data/data/com.termux/files/usr/var/tmp"
            TMP = get_TMP(root)           # $TMPDIR              # "/data/data/com.termux/files/usr/tmp"
            RUN = get_RUNTIME_DIR(root)   # $XDG_RUNTIME_DIR     # "/data/data/com.termux/files/usr/var/run"
            ETC = get_CONFIG_HOME(root)   # $XDG_CONFIG_HOME     # "/data/data/com.termux/files/usr/etc"
            DAT = get_VARLIB_HOME(root)   # $XDG_CONFIG_HOME     # "/data/data/com.termux/files/usr/var/lib"
            LOG = get_LOG_DIR(root)       # $XDG_CONFIG_HOME/log # "/data/data/com.termux/files/usr/var/log"
            CACHE = get_CACHE_HOME(root)  # $XDG_CACHE_HOME      # "/data/data/com.termux/files/usr/var/cache"
    ...
    def remove_service_directories(self, conf, section = Service):
        ...
        if not keepRuntimeDirectory:
            ...
            for name in nameRuntimeDirectory.split(" "):
                ...
                if RUN == "/data/data/com.termux/files/usr/var/run":
                    for var_run in ("/data/data/com.termux/files/usr/var/run", "/data/data/com.termux/files/usr/tmp/run"):
        ...
        for execs in ["ExecStartPre", "ExecStart", "ExecStartPost", "ExecStop", "ExecStopPost", "ExecReload"]:
            ...
            for cmd in conf.getlist(section, execs, []):
                ...
                if not os.path.isfile(exe):
                    ...
                    if mode.check:
                        notexists += 1
                    newexe1 = os.path.join("/data/data/com.termux/files/usr/bin", exe)
